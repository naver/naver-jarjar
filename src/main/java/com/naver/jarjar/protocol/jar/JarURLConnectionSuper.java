...
package com.naver.jarjar.protocol.jar;
...
public abstract class JarURLConnectionSuper extends URLConnection {
	...
	protected JarURLConnectionSuper(URL url) throws MalformedURLException {
		super(url);
		parseSpecs(url);
	}
	...
	private void parseSpecs(URL url) throws MalformedURLException {
		...
		jarFileURL = newURL(spec.substring(0, separator++));
		entryName = null;
	...
	public static URL newURL(String spec) throws MalformedURLException {
		...
		if (spec.startsWith("jar:")) {
			return new URL(null, spec, new com.naver.jarjar.protocol.jar.Handler());
		} else if (spec.startsWith("jarjar:")) {
			return new URL(null, spec, new sun.net.www.protocol.jarjar.Handler());
		} else {
			return new URL(spec);
		}
	}
