...
public class Handler extends URLStreamHandler {
	...
	private String parseAbsoluteSpec(String spec) {
		...
		try {
			...
			if (innerSpec.startsWith("jar:")) {
				url = new URL(null, innerSpec, new com.naver.jarjar.protocol.jar.Handler());
			}
			if (innerSpec.startsWith("jarjar:")) {
				url = new URL(null, innerSpec, this);
			} else {
